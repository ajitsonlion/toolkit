...
@Component({
  selector: 'app-covalent-chips',
  templateUrl: './covalent-chips.component.html',
  styleUrls: ['./covalent-chips.component.scss']
})
export class CovalentChipsComponent implements OnInit {
  chipsAttrs: Object[] = [{
