...
@Component({
  selector: 'app-covalent-expansion',
  templateUrl: './covalent-expansion.component.html',
  styleUrls: ['./covalent-expansion.component.scss']
})
export class CovalentExpansionComponent implements OnInit {
